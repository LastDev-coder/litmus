...
![litmus — a local web app that reveals and removes hidden content from your files](https://raw.githubusercontent.com/LastDev-coder/litmus/main/assets/screenshot.png)
